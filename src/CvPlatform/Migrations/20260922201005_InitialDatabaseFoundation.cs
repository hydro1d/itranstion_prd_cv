        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Positions_AspNetUsers_RecruiterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRequiredDefault = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTagLinks", x => new { x.ProjectId, x.TagId });
                    table.ForeignKey(
                        name: "FK_ProjectTagLinks_ProjectTags_TagId",
                        column: x => x.TagId,
                        principalTable: "ProjectTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTagLinks_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVAttributeValues_CVId_AttributeId",
                table: "CVAttributeValues",
                columns: new[] { "CVId", "AttributeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVLikes_RecruiterId_CVId",
                table: "CVLikes",
                columns: new[] { "RecruiterId", "CVId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscussionMessages_SentAt",
                table: "DiscussionMessages",
                column: "SentAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Positions_EmploymentType",
                table: "Positions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileAttributeValues_CandidateProfileId_AttributeId",
                table: "ProfileAttributeValues",
                columns: new[] { "CandidateProfileId", "AttributeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTagLinks_TagId",
                table: "ProjectTagLinks",
                column: "TagId");
        }
